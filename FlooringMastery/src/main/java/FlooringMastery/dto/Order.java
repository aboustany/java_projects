...
public class Order {
    ...
    public Order(String orderDate, String customerName, String state, BigDecimal taxRate,
    ...
    public Order(String orderDate, String customerName, String state, String productType, BigDecimal area, BigDecimal materialCost, BigDecimal laborCost, BigDecimal tax, BigDecimal total) {
        this.orderDate = orderDate;
        this.customerName = customerName;
        this.state = state;
        this.productType = productType;
